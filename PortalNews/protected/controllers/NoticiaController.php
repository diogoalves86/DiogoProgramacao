...
class NoticiaController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view', 'listaNoticias', 'exibeNoticia'),
				'users'=>array('*'),
			),
	...
	public function actionListaNoticias(){
		$noticias = Noticia::model()->findAll();
		$this->render('listaNoticias', array(
			'noticias'=>$noticias,
		));
	}


	public function actionExibeNoticia($id){
		$noticia = Noticia::model()->find('id='.$id);
		$this->render('exibeNoticia', array(
			'noticia'=>$noticia,
		));
	}
	/**
